...
//    public final static String khs ="select m.nama_mk, m.sks_mk, k.nilai, k.jumlahnilai from Matakuliah m , Khs k where k.kode_mk = m.kode_mk and nim_mhs = :nim_mhs order by nim_mhs";
    @Query("select a.nama_mhs, k.thajaran, m.nama_mk, m.sks_mk, k.nilai, k.jumlahnilai from Matakuliah m, Khs k, Mahasiswa a where k.kode_mk = m.kode_mk and nim_mhs = :nim_mhs order by nim_mhs")
//    @Query(khs)
